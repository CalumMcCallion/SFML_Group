...
void space::spaceGame(sf::RenderWindow& Window) {
...
start:
   ...
   // sf::RenderWindow Window(sf::VideoMode(desktopMode.width, desktopMode.height, desktopMode.bitsPerPixel), "Scroll Game", sf::Style::Fullscreen);
    ...
    if (!font.loadFromFile("fonts/scoreFont.ttf")) { //loading in font for the text graphic
     // handle error
    }
    ...
    sf::Font font1;
    if (!font1.loadFromFile("fonts/scoreFont.ttf")) { //loading in font for the text graphic
    // handle error
    }
    ...
    if (!shipExplode.loadFromFile("media/bomb.png"))
    {
    ...
    if (!gameOverPic.loadFromFile("media/gameO.jpg"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    if (!brokenHeart.loadFromFile("media/brokenHeart.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    sf::Texture lifesPic;
    if (!lifesPic.loadFromFile("media/heart.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    sf::Texture texture;
    if (!texture.loadFromFile("media/ship.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    if (!textureEnemy.loadFromFile("media/enemy.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    if (!deadEnemy.loadFromFile("media/ship.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    if (!textureBullet.loadFromFile("media/Untitled.png"))
    {
        std::cerr << "Error while loading texture" << std::endl;
    ...
    if (!explosion.loadFromFile("media/boom.wav")) {
    ...
    if (!lifeLost.loadFromFile("media/lifeLost.wav")){
    }
    ...
    if (!gameOverS.loadFromFile("media/gameOver.wav")){
    }
    ...
    while (Window.isOpen())
    {
        ...
        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Right) || sf::Keyboard::isKeyPressed(sf::Keyboard::D)) rightFlag = true;
        else if (!sf::Keyboard::isKeyPressed(sf::Keyboard::Right) || sf::Keyboard::isKeyPressed(sf::Keyboard::D)) rightFlag = false;

        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Left) || sf::Keyboard::isKeyPressed(sf::Keyboard::A)) leftFlag = true;
        else if (!sf::Keyboard::isKeyPressed(sf::Keyboard::Left) || sf::Keyboard::isKeyPressed(sf::Keyboard::A)) leftFlag = false;

        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up) || sf::Keyboard::isKeyPressed(sf::Keyboard::W)) upFlag = true;
        else if (!sf::Keyboard::isKeyPressed(sf::Keyboard::Up) || sf::Keyboard::isKeyPressed(sf::Keyboard::W)) upFlag = false;

        if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down) || sf::Keyboard::isKeyPressed(sf::Keyboard::S)) downFlag = true;
        else if (!sf::Keyboard::isKeyPressed(sf::Keyboard::Down) || sf::Keyboard::isKeyPressed(sf::Keyboard::S)) downFlag = false;
        ...
        Texture.loadFromFile("media/spaceScroll.png");
        ...
        if (gameOverFlag == 1) {
            ...
            bullet.setPosition(-10000, -100000000000);
            enemy.setPosition(-10000, -100000000000);
